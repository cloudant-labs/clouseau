...
If you don't have `mise` on your system already, there are extra steps that need to be done.
...
3. Verify your OS has all tools we need using `cli verify`
...
## Monitor metrics using `jconsole`
