...
class LogHistory private (val entries: Chunk[(Int, LogEntry)]) {
  ...
  /*
   * Returns new instance of `LogHistory` which contains only messages which have
   * given annotation and that annotation matches provided `PartialFunction[T, Boolean]` function.
   */
  ...
  /*
   * Returns new instance of `LogHistory` which contains only messages which have
   * given annotation and that annotation matches provided `T => Boolean` function.
   */
  ...
  /*
   * Returns new instance of `LogHistory`
   * which contains only messages of given `callbackName` from given `actorType: String`.
   */
  ...
  /*
   * Returns new instance of `LogHistory`
   * which contains only messages of given `callbackName`.
   */
  ...
  /*
   * Returns Chunk of tuples `(index: Int, message: String)`
   * which contain provided annotation.
   */
  ...
  /*
   * Returns Chunk of tuples `(index: Int, message: String, annotation: String)`
   * which contain provided annotation.
   */
  ...
  /*
   * Returns Chunk of tuples `(index: Int, message: String, annotations: List[Option[String]])`
   * which contain provided annotations. The annotations are returned in the same order as they
   * a listed in annotations argument.
   */
