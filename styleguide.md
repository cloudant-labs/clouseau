# Style Guide for Clouseau 3.x code base

The classes carried over from Clouseau 2.x are not subject to this style guide since the search modernization project is about replacing the `scalang` library and keeping the Clouseau classes intact as much as possible during the transition between Clouseau 2 and 3.
