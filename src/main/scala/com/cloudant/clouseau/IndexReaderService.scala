...
import org.apache.lucene.search.grouping.term.{ TermFirstPassGroupingCollector, TermSecondPassGroupingCollector }
import org.apache.lucene.search.highlight.{ Highlighter, QueryScorer, SimpleFragmenter, SimpleHTMLFormatter }
import org.apache.lucene.util.BytesRef

import scala.collection.JavaConversions._
import scalang.{ Pid, Reference, Service, ServiceContext }
...
class IndexReaderService(ctx: ServiceContext[IndexServiceArgs]) extends Service(ctx) with Instrumented {
